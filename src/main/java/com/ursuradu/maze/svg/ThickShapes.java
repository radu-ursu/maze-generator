...
public class ThickShapes implements ShapeProvider {
  ...
  public String getShapeSvg(final Set<Direction> directions) {
    ...
    if (directions.equals(Set.of(Direction.DOWN))) {
      return """
          <path d="M 100 200 L 100 10" class="path-outer"/>
          <path d="M 100 200 L 100 20" class="path-inner"/>
          """;
    }
    if (directions.equals(Set.of(Direction.UP))) {
      return """
          <path d="M 100 0 L 100 190" class="path-outer"/>
          <path d="M 100 0 L 100 180" class="path-inner"/>
          """;
    }
    if (directions.equals(Set.of(Direction.LEFT))) {
      return """
          <path d="M 0 100 L 190 100" class="path-outer"/>
          <path d="M 0 100 L 180 100" class="path-inner"/>
          """;
    }
    if (directions.equals(Set.of(RIGHT))) {
      return """
          <path d="M 200 100 L 10 100" class="path-outer"/>
          <path d="M 200 100 L 20 100" class="path-inner"/>
          """;
    }
