...
public class SvgGenerator {
    ...
    private void drawPosition(final Position position, final StringBuilder svg, boolean showSolution) {

        final List<MazeNode> mazeNodesAtPosition = board.getMazeNodesAtPosition(position);
        final String svgForNode = getShape(mazeNodesAtPosition, showSolution);
        svg.append(svgForNode);
    }

    private String getShape(final List<MazeNode> nodes, boolean showSolution) {
